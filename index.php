  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="padding: 1px;"><img class="img-responsive" alt="Brand" src="img/logo2.png"  style="width: 170px;margin: 5px;"></a>
        </div>
        ...
        if(!isset($_SESSION['user']))
          {
            echo'
            <li>
                <button type="button" id="login_button" class="btn btn-lg" data-toggle="modal" background-color="#1260CC"  data-target="#login">Login</button>
                ...
                <div id="register" class="modal fade" role="dialog">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h3 class="modal-title text-center">Register Here</h3>
                          </div>
                          <div class="modal-body">
                                        <form class="form" role="form" method="post" action="index.php" accept-charset="UTF-8">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="register_address" class="form-control" placeholder="Address(include Pin Code)" required>
                                                <li></li>
                                                <li></li>
...
?>
  ...
  <div id="top" >
      ...
      <div class="container-fluid" id="header">
          ...
          <div class="row">
              <div class="col-md-4 col-lg-offset-4 justify-content-center" id="category">
                  <div style="background:#1260CC;color:#fff;font-weight:800;border:none;text-align: center;font-size: 35px;padding:10px;margin:20px"> Book Categories </div>
                  <ul>
                      <li style=" font-size: 25px"><b> <a href="Product.php?value=entrance%20exam"> Entrance Exam </a></b> </li>
                      <li style=" font-size: 25px"><b> <a href="Product.php?value=Academic%20and%20Professional"> Academic & Professional </a></b> </li>
                      <li style=" font-size: 25px"><b> <a href="Product.php?value=Biographies%20and%20Auto%20Biographies"> Biographies & Auto Biographies </a> </b></li>
                      <li style=" font-size: 25px"><b> <a href="Product.php?value=Children%20and%20Teens"> Children & Teens </a></b> </li>
                      <li style=" font-size: 25px"><b> <a href="Product.php?value=Regional%20Books"> Regional Books </a> </b> </li>
                      <li style=" font-size: 25px"><b><a href="Product.php?value=Business%20and%20Management"> Business & Management </a></b> </li>
                      <li style=" font-size: 25px"><b> <a href="Product.php?value=Health%20and%20Cooking"> Health and Cooking </a></b> </li>
